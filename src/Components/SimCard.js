              ...
              <div className=" pl-1 mr-16 p-0">
                <div className="font-medium">
                  <div >
                    ...
                    <div className=" ml-3 border-4 rounded-lg">
                      {sNumber}-0000000
                      <button className="hover:text-white font-[Poppins] rounded-lg border-2 border-green-600 md:ml-8  hover:bg-green-400 duration-500">
                        Buy Now
                      </button>
                    </div>
